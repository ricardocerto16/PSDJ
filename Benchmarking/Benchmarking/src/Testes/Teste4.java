...
public class Teste4 implements ITestes {
    ...
    public void execute() {
        ...
        //EXPRESSÃO LAMBDA
        Supplier<Integer> supplier3 = () -> Arrays.stream(array.clone()).reduce(0,(a,b)->a/b);
        ...
        //EXPRESSÃO LAMBDA
        Supplier<Integer> supplier6 = () -> Arrays.stream(array.clone()).parallel().reduce(0,(a,b)->a/b);
        ...
        */
        ...
        /*
        System.out.println("Tempo do Método Static com Streams Sequenciais: " + result4.getKey() + 
                           "\n" + "Resultado da divisão: " + result4.getValue() +"\n\n");
       
        System.out.println("Tempo de BiFunction com Streams Sequenciais: " + result5.getKey() + "\n" + 
                           "Resultado da divisão: " + result5.getValue() +"\n\n");
       
        System.out.println("Tempo de Expressão Lambda com Streams Sequenciais: " + result6.getKey() + "\n" + 

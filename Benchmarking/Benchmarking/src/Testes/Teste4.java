...
public class Teste4 implements ITestes {
    ...
    public void execute() {
        ...
        Supplier<Integer> supplier1 = () -> Arrays.stream(array.clone()).reduce(1, (a,b)->div(a,b));
        SimpleEntry<Double,Integer> result1 = Utilidades.testeBoxGenW(supplier1);
        
            
        //BIFUNCTION
        Supplier<Integer> supplier2 = () -> Arrays.stream(array.clone()).reduce(1,(a,b)->divisao.apply(a,b));
        SimpleEntry<Double,Integer> result2 = Utilidades.testeBoxGenW(supplier2);
        
        //EXPRESSÃO LAMBDA
        Supplier<Integer> supplier3 = () -> Arrays.stream(array.clone()).reduce(1,(a,b)-> a!=0&&b!=0 ? (a>b ? a/b : b/a) : 1);
        ...
        Supplier<Integer> supplier4 = () -> Arrays.stream(array.clone()).parallel().reduce(1,(a,b)->div(a,b));
        SimpleEntry<Double,Integer> result4 = Utilidades.testeBoxGenW(supplier4);
            
        
        //BIFUNCTION
        Supplier<Integer> supplier5 = () -> Arrays.stream(array.clone()).parallel().reduce(1,(a,b)->divisao.apply(a,b));
        SimpleEntry<Double,Integer> result5 = Utilidades.testeBoxGenW(supplier5);
        
        
        //EXPRESSÃO LAMBDA
        Supplier<Integer> supplier6 = () -> Arrays.stream(array.clone()).parallel().reduce(1,(a,b)->a!=0&&b!=0 ? (a>b ? a/b : b/a) : 1);
